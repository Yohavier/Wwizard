...
int main(int, char**)
{
   wwise();
    ...
    ::RegisterClassEx(&wc);
    HWND hwnd = ::CreateWindow(wc.lpszClassName, _T("Wwizard"), WS_OVERLAPPEDWINDOW, 100, 100, 1280, 800, NULL, NULL, wc.hInstance, NULL);
    ...
    //Create Custom GUI
    std::unique_ptr<wwizardGUI::Dockspace> myDock(new wwizardGUI::Dockspace());
    // Main loop
    bool done = false;
    while (!done)
    {
